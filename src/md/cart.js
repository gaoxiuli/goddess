...
var cart = {
    ...
    addproduct: function (product) {  
        ...
        if (ShoppingCart == null || ShoppingCart == "") {  
            //第一次加入商品  
            var jsonstr = { "productlist": [{ "id": product.id, "name": product.name, "image":product.image, "num": product.num, "price": product.price}], "totalNumber": product.num, "totalAmount": (product.price * product.num) };  
            ...
            if (!result) {  
                //没有该商品就直接加进去  
                productlist.push({ "id": product.id, "name": product.name,"image":product.image, "num": product.num, "price": product.price });  
            }  
            //重新计算总价  
