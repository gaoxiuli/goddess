  		...
  		<div class="login_page">
	  		...
	  		<div class="form">
	  			<div class="f">
	  				...
	  				<div class="mm">
	  					<input type="text" placeholder="验证码" v-model="myYzm" id="phone" @focus="focusFuns($event)" @blur="blurFuns($event)" class="yzm"/>
	  					<div class="mima2" @click="clickYzm($event)">
	  						获取验证码
	  					</div>
	  				</div>
	  				<div class="yz">
		  			...
		  			<input type="button" value="注册" id="btn" @click="submit()"/>
...
//			      	console.log(data)
			...
			submit(){
				...
				if(document.getElementsByClassName("yzm")[0].value==""){
					 ...
					 $.ajax({
				        type:"post",
				        url:"http://localhost:3000/users/registerAction",
				        data:{
				        	username:iphone,
